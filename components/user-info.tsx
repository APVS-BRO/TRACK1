...
export const UserInfo = ({
    ...
    return (
        <main className="pl-[20vw] w-full min-h-screen flex flex-col gap-24 h-full px-24 py-16 overflow-auto">
            ...
            <div className="flex flex-col gap-5 w-full">
                ...
                <div className={` flex rounded-full w-full`}>
                    <div style={{ width: `${questionDone.correctnessPercentage}%` }} className="flex flex-col gap-2 items-center justify-center">
                        <div className={`h-full bg-green-500 rounded-full flex justify-end border-white border-2 w-full`}  >
                            <div className="p-0.5 bg-white rounded-full w-fit aspect-square h-8 flex items-center justify-center"><FaCheck className="text-base text-green-500" /></div>
                        </div>
                    ...
                    <div style={{ width: `${100 - questionDone.correctnessPercentage}%` }} className="flex flex-col gap-2 items-center justify-center">
                        <div className={`h-full bg-red-500 rounded-full flex justify-end border-white border-2 w-full`} >
                            <div className="p-0.5 bg-white rounded-full w-fit aspect-square h-8 flex items-center justify-center"><ImCross className="text-base text-red-500" /></div>
                        </div>
